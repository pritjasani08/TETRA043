...
import { ShieldCheck, Eye, EyeOff, CheckCircle2, ChevronRight, Check, Loader2 } from "lucide-react";
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <div className="mb-10 text-center relative z-10">
              <h2 className="font-display text-2xl font-bold tracking-tight text-white">
                {activeTab === "login" ? "Welcome Back" : "Register Farm"}
              </h2>
              <p className="mt-2 text-sm text-white/50 font-light">
                {activeTab === "login" ? "Sign in to your AgriShield console." : "Create an account to start monitoring."}
              </p>
              
              <TabsList className="grid w-full grid-cols-2 bg-white/5 border border-white/10 rounded-xl mt-6 p-1">
                <TabsTrigger value="login" className="rounded-lg data-[state=active]:bg-[#A3E635] data-[state=active]:text-[#07111F] text-white">Sign In</TabsTrigger>
                <TabsTrigger value="signup" className="rounded-lg data-[state=active]:bg-[#A3E635] data-[state=active]:text-[#07111F] text-white">Register</TabsTrigger>
              </TabsList>
            </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {(
                    ...
                    <div key={key} className="space-y-1.5 group">
                      <Label htmlFor={key} className="text-[11px] font-semibold uppercase tracking-widest text-white/40 group-focus-within:text-[#A3E635] transition-colors duration-300">
                        {label}
                      </Label>
                      <Input
                        id={key}
                        ...
                        className="bg-white/[0.03] border-white/[0.08] hover:bg-white/[0.05] hover:border-white/20 focus-visible:bg-white/[0.05] focus-visible:ring-[#A3E635]/40 focus-visible:border-[#A3E635] transition-all duration-300 rounded-xl h-10 px-3 text-sm text-white placeholder:text-white/30"
                      />
                    </div>
                  ))}
                  <div className="space-y-1.5 sm:col-span-2 group">
                    <Label htmlFor="signup-password" className="text-[11px] font-semibold uppercase tracking-widest text-white/40 group-focus-within:text-[#A3E635] transition-colors duration-300">
                      Password
                    </Label>
                    <Input 
                      id="signup-password" 
